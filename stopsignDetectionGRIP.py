...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_0_hue = [165.10791366906474, 180.0]
        self.__hsv_threshold_0_saturation = [92.78035198959476, 255.0]
        self.__hsv_threshold_0_value = [59.62230215827338, 255.0]

        self.hsv_threshold_0_output = None


        self.__hsv_threshold_1_hue = [0.0, 9.522184300341308]
        self.__hsv_threshold_1_saturation = [99.22799048896475, 255.0]
        self.__hsv_threshold_1_value = [43.57014388489208, 255.0]
        ...
        self.__filter_contours_solidity = [74.41016333938293, 100]
